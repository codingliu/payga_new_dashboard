<template>
  <div class="app-config">
    <a-form class="w-full md:w-full mt-3" :model="appInfo" @submit="modifyInfo">
      <a-divider orientation="left">{{ tr('登录密码') }}</a-divider>
      <a-form-item :label="tr('原始登录密码')" label-col-flex="200px"
                   :rules="[{required:true,message:tr('原始登录密码必填')}]">
